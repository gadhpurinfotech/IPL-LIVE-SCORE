...
public class Constants {
    public String series_name, state;
    ...
    public String vcity, vcountry, stTme, startdt;
    ...
    public String sr;
    public String player_id, player_fName, player_name, value_squad_team2, news_id, news_datapath, hline, intro, namelocation, location, news_date, src, isE, topic_name;
